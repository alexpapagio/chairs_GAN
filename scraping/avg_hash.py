"""
This module uses image average hashing to help us detect duplicate and
similar images.

See also the perceptual hashing module for a slower approach that should find
more similarities.
...
def main():
    """
    For each jpg file in passed directory, calculate the average hash
    and move observed clusters to new subdirectories for manual review.
    """
    print("Starting image hashing")
    if len(sys.argv) != 2:
        print("Usage: python3 avg_hash.py <directory>")
        sys.exit(1)
